...
const submenuItems = [
  {
    title: 'Overview',
    href: '/admin/constructor-stats',
    icon: BarChart3,
    description: 'Constructor statistics and analytics',
  },
  {
    title: 'Compare Constructors',
    href: '/admin/constructor-stats/compare',
    icon: Flag,
    description: 'Side-by-side constructor comparison',
  },
]

export default function ConstructorStatsLayout({
  children,
}: {
